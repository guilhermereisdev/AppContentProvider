...
import br.com.guilhermereisapps.appcontentprovider.database.MyContentProvider.Companion.URI_NOTES
import br.com.guilhermereisapps.appcontentprovider.database.NotesDatabaseHelper.Companion.DESCRIPTION_NOTES
import br.com.guilhermereisapps.appcontentprovider.database.NotesDatabaseHelper.Companion.TITLE_NOTES
...
class NotesDetailFragment : DialogFragment(), DialogInterface.OnClickListener {
    ...
    override fun onClick(p0: DialogInterface?, p1: Int) {
        // só altera se o botão clicado for o de salvar
        if (p1 == BUTTON_POSITIVE) {
